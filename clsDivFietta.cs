...
namespace APOffice
{
    class clsDivFietta
    {
        ...
        public DataRow DivFat(string strRig, DataRow rowArt, DateTime dayDdo)
        {
            ...
            rowArt["div_arf"] = strRig.Substring(15, 7).Trim();
            rowArt["div_ard"] = strRig.Substring(22, 30).Trim();
            rowArt["for_umi"] = strRig.Substring(52, 2).Trim();
            rowArt["div_pxc"] = Convert.ToDecimal(strRig.Substring(78, 5).Trim());
            rowArt["div_cos"] = _clsFun.Txt2Dec(strRig.Substring(61, 9)) / 1000;
            rowArt["div_imp"] = _clsFun.Txt2Dec(strRig.Substring(70, 8)) / 100;
            rowArt["div_qta"] = Convert.ToDecimal(strRig.Substring(54, 5).Trim());
            rowArt["for_iva"] = "0" + strRig.Substring(84, 2).Trim();
            rowArt["div_ean"] = "";
            //if (strRig.Length > 88)
            //    strRig.Substring(89).Trim();
        ...
        public DataRow DivBol(string strRig, DataRow rowArt, DateTime dayDdo)
        {
            string s = "";

            rowArt["div_dva"] = dayDdo;
            rowArt["div_arf"] = strRig.Substring(1, 7).Trim();
            rowArt["div_ard"] = strRig.Substring(8, 35).Trim();
            rowArt["for_umi"] = "PZ";   //strRig.Substring(43, 2)
            //rowArt["div_pxc"] = 1; 
            rowArt["div_cos"] = _clsFun.Txt2Dec(strRig.Substring(52, 10)) / 1000;
            rowArt["div_qta"] = Convert.ToDecimal(strRig.Substring(45, 5).Trim()) / 100;
            rowArt["for_iva"] = "0" + strRig.Substring(62, 2).Trim();
            ...
            if (strRig.Length > 65)
                rowArt["div_ean"] = strRig.Substring(64,13).Trim();
