...
namespace APOffice
{
    public partial class frmGesMovIngLabel04 : Form
    {
        ...
        {
            //_clsFun.FileLog("Eti 4", "Passo 1", "");

            string s = "";
            if (_strLotCod != "" && _strLotCod.Length > 2)
            {
                //_clsFun.FileLog("Eti 4", "Passo 2", "");

                string[] a = _strLotCod.Split('-');

                if (a.Length >= 3)
                {
                    //_clsFun.FileLog("Eti 4", "Passo 3", "");
            ...
            //_clsFun.FileLog("Eti 4", "Passo 4", _str001_Print);
            ...
            {
                //_clsFun.FileLog("Eti 4", "Passo 5", _str001_Print);
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            try
            {
                ...
                if (_strEtiTipo == "02") 
                {
                    ...
                    string sLog = _clsFun.PathApOffice("C:\\ApProject\\Temp\\Img\\LogoEti04.png");

                    //_clsFun.ErrorLog("LogoEti04", sLog);
        ...
        private string FillFont(string strTip)
        {
            ...
            string sFil = Path.GetDirectoryName(_clsDef.FILEINI) + "\\EtiNomeFont4.ini";

            //_clsFun.FileLog("Eti 4", "Passo 6", _clsDef.FILEINI);
            //_clsFun.FileLog("Eti 4", "Passo 7", sFil);
        ...
        {
            string s = _clsFun.FileIniIni("001");
