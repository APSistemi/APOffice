...
namespace APOffice
{
    public partial class frmAnaDivForTesta : Form
    {
        ...
        private Boolean Salva()
        {
            ...
            else
            {
                ...
                DataTable t = _clsFun.FillTabMdb("AnaForDivTipi", s, true, _strConSqlMdb);
                DataRow x = t.NewRow();
                x["trk_cod"] = sCod;
                ...
                if (sCod == _clsDef.CODNEW)
                {
                    ...
                    DataTable tTrt = _clsFun.FillTabMdb("AnaForDivTestate", s, true, _strConSqlMdb);
                ...
                t = _clsFun.FillTabMdb("AnaForDivTestate", s, true, _strConSqlMdb);
                x = t.NewRow();
        ...
        private string TipoNuovo()
        {
            ...
            DataTable t = _clsFun.FillTabMdb("AnaForDivTipi", s, false, _strConSqlMdb);
