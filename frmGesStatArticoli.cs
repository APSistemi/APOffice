...
namespace APOffice
{
    public partial class frmGesStatArticoli : Form
    {
        ...
        private void FillDati()
        {
            ...
            foreach (DataRow y in t.Rows)
            {
                ...
                j = tArt.Select("art_cod='" + (string)y["ven_art"] +"'");
                if(j.Length > 0)
                {
        ...
        private void excelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            s = "";
            s += "ven_sco, Scontrino, 100, StringLiteral;";
            ...
            s += "ven_ora, Ora, 50, StringLiteral;";
            s += "ven_iva, Iva, 50, StringLiteral;";
            s += "tmp_sta, Stato, 50, StringLiteral;";
            s += "ven_sct, Battuta, 50, StringLiteral;";
